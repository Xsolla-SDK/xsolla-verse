...
const DOCS = {
  academy: 'https://xsolla-academy.com',
  accelerator: 'https://accelerator.xsolla.com/',
  sdk: 'https://developers.xsolla.com/sdk/',
  explorer: 'https://developers.xsolla.com/sdk/demo/',
  unityQuick: 'https://developers.xsolla.com/sdk/unity/quick-start/',
  list: 'https://developers.xsolla.com/sdk/list-of-sdk/',
  publisher: 'https://publisher.xsolla.com/',
}
...
const INTEGRATION_STEPS = [
  ...
  },
  {
    ...
    title: 'Load catalog',
    body:
      'Fetch SKUs and product metadata from Xsolla (or declare products for Unity IAP). Surface prices and items in your in-game store UI.',
  },
  {
    n: '03',
    title: 'Purchase',
    body:
      'Call the SDK purchase API for a SKU. Xsolla Pay Station opens (native or Buy Button → Web Shop) with 1,000+ payment methods.',
  },
  {
    n: '04',
    title: 'Finalize',
    body:
      'Acknowledge the transaction, grant items, and for production validate with Xsolla webhooks or the Events API on your server.',
  },
]
...
const PLATFORMS = [
  ...
  },
  {
    ...
    href: 'https://developers.xsolla.com/sdk-client-side/unreal-engine/',
  },
]

/**
 * In-lobby Xsolla Academy + SDK primer (links to official Xsolla docs).
 */
const AcademyPanel = () => (
  <Wrap>
    <Hero>
      <Eyebrow>Learn · Build · Monetize</Eyebrow>
      <Title>Xsolla Academy</Title>
      <Lead>
        Gamified training from Xsolla for game business, monetization, marketing,
        distribution, investment, and Xsolla solutions — plus the SDK path to
    ...
    <Section>
      ...
      <Note>
        Xsolla Academy Online (XAO) is free to join at{' '}
    ...
    <Section>
      <SectionTitle>Introduce the Xsolla SDK</SectionTitle>
      <LeadTight>
        <strong>Xsolla SDK 3</strong> helps you monetize and go live across App
        Store, Google Play, Android APK, iOS, Xsolla Launcher, and standalone PC
        — powered by <strong>Xsolla Pay Station</strong>. One integration also
    ...
    <Section>
      ...
      <Note>
        ...
        <InlineA href={DOCS.list} target="_blank" rel="noopener noreferrer">
          developers.xsolla.com/sdk/list-of-sdk
        </InlineA>
      </Note>
    </Section>
  </Wrap>
